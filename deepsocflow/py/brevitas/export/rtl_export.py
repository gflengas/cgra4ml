...
Why a fork instead of reuse: deepsocflow/py/brevitas/export/adapter.py used to call the
...
fields (dropped - deepsocflow/py/brevitas/export/xtensor.py's XTensor already holds
